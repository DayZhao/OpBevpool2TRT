...
from ops.bevpool.bev_pool_onnx import bev_pool_v2
class LSSViewTransformer(nn.Module):
    ...
    def pre_op_input(self, bs):
        coor = self.frustum.unsqueeze(0).expand(bs, -1, -1, -1, -1)
        return self.voxel_pooling_prepare_v2(coor)
